...
insight.opentelemetry.io/metric-port: "8001"   # install.sh 按 release 改写
...
| `service.port` | `8001` | 与 `podAnnotations.metric-port` 一致 |
...
| `config.kvCacheSize` | `2048` | KV cache block 数 |
